...
void MurmurHash3_x86_128(const void * key, const int len,
    ...
    const unsigned int c1 = 0x239b961b;
    const unsigned int c2 = 0xab0e9789;
    const unsigned int c3 = 0x38b34ae5;
    const unsigned int c4 = 0xa1e38b93;
    ...
    for (int i = -nblocks; i; i++) {
        unsigned int k1 = getblock32(blocks, i * 4 + 0);
        unsigned int k2 = getblock32(blocks, i * 4 + 1);
        unsigned int k3 = getblock32(blocks, i * 4 + 2);
        unsigned int k4 = getblock32(blocks, i * 4 + 3);
    ...
    const unsigned __int8 * tail = (const unsigned __int8*)(data + nblocks * 16);
